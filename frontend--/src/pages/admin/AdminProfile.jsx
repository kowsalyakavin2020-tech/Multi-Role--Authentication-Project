      ...
      <div className="max-w-2xl">
        ...
        <div className="bg-white rounded-b-xl shadow-md p-6">
          ...
          <div className="flex items-center justify-between py-4">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 bg-red-100 rounded-lg flex items-center justify-center text-red-700 font-bold text-sm">
                A
              </div>
              <div>
                <p className="text-xs text-gray-400">Access Level</p>
                <p className="text-gray-800 font-semibold">Full Access</p>
              </div>
            </div>
